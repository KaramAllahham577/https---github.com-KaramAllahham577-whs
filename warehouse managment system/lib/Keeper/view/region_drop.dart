...
class RegionDropdown extends StatelessWidget {
  final RegionController addressController = Get.put(RegionController());
final bool co;
  RegionDropdown({super.key, required this.co});
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide:  BorderSide(
                      color:co?Color(0xff6a040f):Color(0xff007f5f),
                      width: 2.5,
                    ),
                  ),
                ),
                ...
                onChanged: (newValue) {
                  if (newValue != null) {
                    ...
                    if (newValue.id == 0) {
                      ...
                      print('Selected Address ID: ${newValue.region.city.country.id}');
                    }
                  }
                },
                items: [
                   DropdownMenuItem<Address>(
                    value: null,
                    child:co? Text("Select Source Region"):const Text("Select Destination Region"),
                  ),
                  ...addresses.map<DropdownMenuItem<Address>>((Address address) {
                    return DropdownMenuItem<Address>(
                      value: address,
                      child: Text(address.region.region),
                    );
                  }).toList(),
                ],
              );

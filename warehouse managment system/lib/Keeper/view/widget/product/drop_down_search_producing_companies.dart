...
class DropDownSearchProducingCompanies extends GetView<AddProductGeneralController> {
  final List<String> items = List.generate(50, (index) => "Item $index");

  DropDownSearchProducingCompanies({super.key});
          ...
          children: <Widget>[
            TypeAheadFormField<String>(
              textFieldConfiguration: TextFieldConfiguration(
                ...
                controller: controller.producingController,
              ),
              suggestionsCallback: (pattern) {
                return controller.getSuggestionsProducing(pattern);
              },
              ...
              onSuggestionSelected: (String suggestion){controller.producingController.text = suggestion;
              int selectedCategoryId =
              controller.getCategoryIdByNamep(suggestion);
              box.storage("idProducing", selectedCategoryId);

...
class SearchEmployee extends SearchDelegate<String> {
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestionList = search
        .where((item) => item.employee.employeeName
        .toString()
        .toLowerCase()
    ...
    return Container  (
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            child: CardEmp(position: item.employee.position, employeeName: item.employee.employeeName!,),
            onTap: (){
              box.storage("idEmp", item.id) ;

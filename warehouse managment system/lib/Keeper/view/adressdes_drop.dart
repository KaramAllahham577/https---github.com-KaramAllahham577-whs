...
class ApiService {
  ...
  static Future<List<Address>> getAddresses() async {
    final response = await http.get(
      Uri.parse('http://$Ip:8000/api/managers/show/addresses'),
...
class AddressDestinationController extends GetxController {
...
class AddressDestinationDropdown extends StatelessWidget {
  final AddressDestinationController addressController =
      Get.put(AddressDestinationController());
            ...
            return DropdownButtonFormField<Address>(
              ...
              items: [
                const DropdownMenuItem<Address>(
                  value: null,
                  child: Text("Select Destination address"),
                ),

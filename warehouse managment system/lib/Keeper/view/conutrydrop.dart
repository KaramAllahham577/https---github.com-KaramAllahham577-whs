...
class CountryDropdown extends StatelessWidget {
  final CountryController addressController = Get.put(CountryController());
  final bool co;
   CountryDropdown({super.key, required this.co});
              ...
              return DropdownButtonFormField<Address>(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide:  BorderSide(
                      color:co?const Color(0xff6a040f):const Color(0xff007f5f),
                      width: 2.5,
                    ),
                  ),
                ),
                ...
                items: [
                   DropdownMenuItem<Address>(
                    value: null,
                    child: co?const Text("Select Source Country"):const Text("Select Destination Country"),
                  ),

...
class Shipment_Details extends StatelessWidget {
  Shipment_Details(this._shipmentDetails);
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Transform.rotate(
                    angle: -3.14 / 2, child: Container(child: const Rectangle1())),
                const SizedBox(
                  width: 5,
                ),
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(width: 2, color: const Color(0xff007f5f)),
                  ),
                  child: Column(
                    children: [
                      Container(

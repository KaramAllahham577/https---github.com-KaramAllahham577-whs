...
import 'package:untitled3/General/data/remote/sh.dart';
...
import '../../Keeper/data/model/AddShipmentModel.dart';

class AddShipmentControllerG extends GetxController {
  ...
  AddShipmentDataG addShipmentData = AddShipmentDataG(Get.find());

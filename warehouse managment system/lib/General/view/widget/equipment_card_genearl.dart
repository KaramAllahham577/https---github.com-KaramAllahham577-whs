...
class EquipmentCardGeneral extends StatelessWidget {
   final ShowEquipmentsGeneralModel Equipments;

  const EquipmentCardGeneral({super.key, required this.Equipments});

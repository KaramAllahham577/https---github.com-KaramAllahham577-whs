...
import '../../../../Keeper/view/screen/storage_location/SecondryStoringLocations.dart';
...
class StoringLocationsGeneral extends StatelessWidget {
  const StoringLocationsGeneral({super.key});
  ...
  Widget build(BuildContext context)
{
    ...
    AppColor a = AppColor();
    Get.put(MainSectionGeneralController());
    Get.put(AddStorageLocationGeneralController());
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            GetBuilder<MainSectionGeneralController>(builder: (controller) {
        ...
        floatingActionButton: GetBuilder<AddStorageLocationGeneralController>(builder: (controller){

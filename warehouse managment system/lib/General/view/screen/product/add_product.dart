...
import '../../../../Keeper/view/widget/product/drop_down_search_category.dart';
import '../../../../Keeper/view/widget/product/drop_down_search_producing_companies.dart';

import '../../../controller/product/add_product_controller.dart';
import '../../../controller/product/edit_product_controller.dart';


class AddProductGeneral extends GetView<AddProductGeneralController> {
  const AddProductGeneral({Key? key}) : super(key: key);
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Padding(
                ...
                child: GetBuilder<AddProductGeneralController>(
                  builder: (controller) {
                    return Form(
                                ...
                                child: Card(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          width: 400,
                                          child:DropDownSearchProducingCompanies()
                                      ),
                                      const SizedBox(height: 16),
                                      Container(
                                          ...
                                          DropdownButton<String>(
                                            ...
                                            dropdownColor: AppColor.color2,

                                            value: controller.selectedValue.value,
                                            onChanged: (newValue) {
                                              controller.updateSelectedValue(newValue!);
                                            },
                                            items: <String>['CM', 'Kg', 'L', 'G', 'M'].map((String value) {

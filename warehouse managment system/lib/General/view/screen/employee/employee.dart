...
import '../../../controller/employee/show_employee_branch_general_controller.dart';
import '../../widget/employee/search_employee.dart';
import 'employee_profile.dart';

class ShowEmployeeGeneral
    extends GetView<ShowEmployeeControllerGeneral> {
  const ShowEmployeeGeneral({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final box = Get.put(StorageController());

    Get.put(ShowEmployeeControllerGeneral());
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(child:
              GetBuilder<ShowEmployeeControllerGeneral>(
                  builder: (controller) {

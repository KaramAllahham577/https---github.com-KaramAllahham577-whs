...
import '../../../../Keeper/view/widget/employee/custom_container.dart';
import '../../../../Keeper/view/widget/employee/top_portion.dart';
import '../../../controller/employee/employee_profile_controller.dart';



class EmployeeProfileGeneral extends StatelessWidget {
  const EmployeeProfileGeneral({Key? key, }) : super(key: key);


  @override
  Widget build(BuildContext context) {
    EmployeeProfileControllerGeneral controller = Get.put(EmployeeProfileControllerGeneral());
    return Scaffold(
      body: Container(
